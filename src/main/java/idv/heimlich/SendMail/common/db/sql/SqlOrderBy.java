package idv.heimlich.SendMail.common.db.sql;

import java.util.HashMap;
import java.util.Map;

import idv.heimlich.SendMail.common.db.utils.SqlFormatUtil;
import idv.heimlich.SendMail.common.exception.ApBusinessException;
